...
export default function Header({ isAdmin, onAdminClick, onLogout }: HeaderProps) {
  return (
    <header className="flex items-center justify-between px-4 py-2 bg-green-700 text-white shrink-0 z-10 shadow-md">
      <div className="flex items-center gap-3">
        <div className="w-14 h-14 rounded-full overflow-hidden shrink-0 bg-white">
      ...
      <div className="flex items-center gap-2">
        {isAdmin ? (
          <>
            <span className="text-xs text-green-100 hidden sm:block">Đã đăng nhập</span>
            <button
              onClick={onLogout}
