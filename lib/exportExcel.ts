...
function buildForm3Sheet(ws: WS, item: NguonGen, ext: ExtendedFormData) {
  ...
  if (isTT) {
    ...
    dataRow(ws, r++, "10. Dạng cây", f3.ln_dang_cay);
    dataRow(ws, r++, "11. Chiều cao vút ngọn Hvn (m)", f3.ln_chieu_cao_hvn);
    dataRow(ws, r++, "11. Chiều cao dưới cành Hdc (m)", f3.ln_chieu_cao_hdc);
    dataRow(ws, r++, "12. Đường kính ngang ngực D1.3 (cm)", f3.ln_duong_kinh_d13);
    dataRow(ws, r++, "13. Đặc điểm gốc cây", f3.ln_dac_diem_goc);
    dataRow(ws, r++, "14. Sắc tố cành non", f3.ln_sac_to_canh_non);
    dataRow(ws, r++, "15. Lông ở cành non", f3.ln_long_canh_non);
    dataRow(ws, r++, "16. Góc phân cành", f3.ln_goc_phan_canh);
    dataRow(ws, r++, "17. Hình thái tán cây", f3.ln_hinh_thai_tan);
    dataRow(ws, r++, "18. Đường kính tán Dt (m)", f3.ln_duong_kinh_tan);
    dataRow(ws, r++, "19. Hình dạng lá", f3.ln_hinh_dang_la);
    dataRow(ws, r++, "20. Kiểu lá", f3.ln_kieu_la);
    dataRow(ws, r++, "21. Cuống lá", f3.ln_cuong_la);
    dataRow(ws, r++, "22. Kích thước lá — Dài × Rộng (cm)", f3.ln_kich_thuoc_la);
    dataRow(ws, r++, "23. Gân lá", f3.ln_gan_la);
    dataRow(ws, r++, "24. Màu lá", f3.ln_mau_la);
    dataRow(ws, r++, "25. Màu lá non", f3.ln_mau_la_non);
    dataRow(ws, r++, "26. Mép lá", f3.ln_mep_la);
    dataRow(ws, r++, "27. Đầu lá", f3.ln_dau_la);
    dataRow(ws, r++, "28. Đuôi lá", f3.ln_duoi_la);
    dataRow(ws, r++, "29. Sắp xếp lá", f3.ln_sap_xep_la);
    dataRow(ws, r++, "30. Kiểu hoa", f3.ln_kieu_hoa);
    dataRow(ws, r++, "31. Kiểu đính hoa", f3.ln_kieu_dinh_hoa);
    dataRow(ws, r++, "32. Kích thước hoa — đường kính (mm)", f3.ln_kich_thuoc_hoa);
    dataRow(ws, r++, "33. Hình dạng hoa", f3.ln_hinh_dang_hoa);
    dataRow(ws, r++, "34. Đế hoa", f3.ln_de_hoa);
    dataRow(ws, r++, "35. Đài hoa", f3.ln_dai_hoa);
    dataRow(ws, r++, "36. Tràng hoa", f3.ln_trang_hoa);
    dataRow(ws, r++, "37. Màu sắc tràng hoa", f3.ln_mau_sac_trang_hoa);
    dataRow(ws, r++, "38. Nhị hoa", f3.ln_nhi_hoa);
    dataRow(ws, r++, "39. Bao phấn", f3.ln_bao_phan);
    dataRow(ws, r++, "40. Nhụy hoa", f3.ln_nhuy_hoa);
    dataRow(ws, r++, "41. Mùi hoa", f3.ln_mui_hoa);
    dataRow(ws, r++, "42. Hướng mọc của hoa", f3.ln_huong_moc_hoa);
    dataRow(ws, r++, "43. Kiểu quả", f3.ln_kieu_qua);
    dataRow(ws, r++, "44. Loại quả", f3.ln_loai_qua);
    dataRow(ws, r++, "45. Hình dạng quả", f3.ln_hinh_dang_qua);
    dataRow(ws, r++, "46. Kích thước quả — Dài × Rộng/đường kính (cm)", f3.ln_kich_thuoc_qua);
    dataRow(ws, r++, "47. Màu sắc vỏ quả khi chín", f3.ln_mau_vo_qua);
    dataRow(ws, r++, "48. Số hạt trên quả (TB)", f3.ln_so_hat_qua);
    dataRow(ws, r++, "49. Dạng hạt", f3.ln_dang_hat);
    dataRow(ws, r++, "50. Bề mặt hạt", f3.ln_be_mat_hat);
    dataRow(ws, r++, "51. Màu hạt", f3.ln_mau_hat);
    dataRow(ws, r++, "52. Kích thước hạt — Dài × Rộng (mm)", f3.ln_kich_thuoc_hat);
  ...
  if (isTT) {
    ...
    dataRow(ws, r++, "59. Hình thức sinh trưởng", f3.hinh_thuc_sinh_truong);
    dataRow(ws, r++, "60. Tỷ lệ nảy mầm", f3.ti_le_nay_mam);
    dataRow(ws, r++, "61. Điều kiện nảy mầm", f3.dieu_kien_nay_mam);
    dataRow(ws, r++, "62. Thời gian từ khi gieo đến khi mọc (ngày)", f3.thoi_gian_khi_gieo_moc);
    dataRow(ws, r++, "63. Thời gian từ trồng đến ra hoa, kết quả (năm)", f3.ln_thoi_gian_ra_hoa);
    dataRow(ws, r++, "64. Thời gian từ trồng đến thu hoạch (năm)", f3.ln_thoi_gian_thu_hoach);
  } else if (isDL) {
